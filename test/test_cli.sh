...
exit_status_success_is_test_passed () {
  if [ $? -ne 0 ]
  then 
...
exit_status_success_is_test_failed () {
  if [ $? -ne 0 ]
  then
  ((num_ok=num_ok+1))
  else
...
exit_status_success_is_test_passed "identifier_assign"
...
exit_status_success_is_test_passed "identifier_enumerate"
echo ""
...
exit_status_success_is_test_passed "personality_create"
...
exit_status_success_is_test_passed "seal_data"
...
exit_status_success_is_test_passed "unseal_data"
echo ""
...
exit_status_success_is_test_passed "personality_enumerate"
...
exit_status_success_is_test_passed "personality_enumerate_application"
echo ""
...
exit_status_success_is_test_passed "personality_add_attribute"
...
exit_status_success_is_test_passed "personality_get_attribute"
echo ""
echo ""
...
exit_status_success_is_test_passed "personality_attributes_enumerate"
echo ""
...
exit_status_success_is_test_passed "personality_remove_attribute"
echo ""
...
exit_status_success_is_test_passed "authenticate_data_detached"
...
exit_status_success_is_test_passed "personality_enroll"
echo ""
...
exit_status_success_is_test_passed "personality_remove"
...
exit_status_success_is_test_failed "personality_remove"
echo ""
